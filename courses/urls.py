...
urlpatterns = [
    ...
    path('enrollment/', StudentEnrollmentCreateList.as_view(), name='Enrollment_list_create'),
    path('enrollment/<int:enrollment_id>/', StudentEnrollmentRetrieveUpdateDelete.as_view(), name='Enrollment_detail'),
